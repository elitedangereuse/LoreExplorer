...
:ROAM_REFS: https://elite-dangerous.fandom.com/wiki/Alioth https://edgis.elitedangereuse.fr/static/sysmap.html?system=Alioth
:END:
#+title: Alioth
#+filetags: :Empire:Federation:Alliance:beacon:Reputation:Permit:System:

#+begin_quote
The Alioth system is notable as the home of the Alliance, one of the
galaxy's three superpowers. The system was the focus of conflict
between the Federation and the Empire in the 3200s due to its
tremendous mineral wealth, but the expulsion of Federal and Imperial
forces by Alioth's indigenous population led to the creation of the
Alliance in 3230. The permit for this system can be obtained from
the Alioth Independents.
#+end_quote

Related: [[id:1d726aa0-3e07-43b4-9b72-074046d25c3c][The Alliance]].
