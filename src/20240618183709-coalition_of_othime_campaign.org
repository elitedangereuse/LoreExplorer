...
“Othime relies heavily on its refineries, but those refineries are limited to small and medium cargo vessels, which limits the amount of revenue we can generate. A new asteroid base would allow us to support large ships, such as the Anaconda and [[id:ab621e71-06dd-443a-a038-6e84e1c9e04e][Imperial Cutter]], and allow us to compete with other refineries in the sector.”
